...
function ExchangeRates() {
  ...
  if (data) {
    ...
    return (
    <div>
      <h4>{data.organization.repositories.nodes[0].name}| Frome: <a href={data.organization.repositories.nodes[0].owner.url} target="_blank"> {data.organization.repositories.nodes[0].owner.login} </a> |Created: {data.organization.repositories.nodes[0].createdAt}</h4>
